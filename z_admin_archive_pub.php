...
<html lang='uk'>
    ...
    <head>
        <title>Архів вакансій Паблік - Адмін</title>
        <meta charset="utf-8">
...
<!--VACANCY INFO-->
    <div class="blok16">
        <?php
        $vac_info = $conn->query("SELECT id, company, vacancy, city, search, web, web_link, politely, professionally, interested, operatively, conformity, communication, salary, other1, other2, other3, status, manager, date FROM vacs WHERE status='archive' ORDER BY general_score DESC");
