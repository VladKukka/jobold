...
<html lang='uk'>
    ...
    <head>
        <title>Додати вакансію - Менеджер</title>
        <meta charset="utf-8">
...
<!--FORM-->  
    <center>
        <form method="post" action="yy_exe.php">
            <input class="form_place2" type="hidden" name="user_name" value="<?php echo $user_name; ?>" required><br>
